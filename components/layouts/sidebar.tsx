                ...
                <div className="h-full bg-white dark:bg-black">
                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'dashboard' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <Link href='/payment-details'>{t('approvePaymentDetails')}</Link>
                                        </li>
                                        <li>
                            ...
                            <h2 className="-mx-4 mb-1 flex items-center bg-white-light/30 px-7 py-3 font-extrabold uppercase dark:bg-dark dark:bg-opacity-[0.08]">
                                <IconMinus className="hidden h-5 w-4 flex-none" />
                                <span>{t('call_and_transactions')}</span>
                            </h2>

                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'calls_transactions' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('calls_transactions')}>
                                    <div className="flex items-center">
                                        <IconMenuUsers className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('call_and_transactions')}</span>
                                    </div>

                                    <div className={currentMenu !== 'calls_transactions' ? '-rotate-90 rtl:rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>

                                <AnimateHeight duration={300} height={currentMenu === 'calls_transactions' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href="/calls">{t('calls')}</Link>
                                        </li>
                                        <li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'users' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        {/* <li>
                                            <Link href="/users/my-profile">{t('profile')}</Link>
                                        </li> */}
                                        <li>
                                        ...
                                        <li>
                                            <Link href='/users/partner-onboarding'>{t('partnerOnboarding')}</Link>
                                        </li>
                                        {/* <li>
                            ...
                            <li className="menu nav-item">
                                <Link href="/partners" className="group">
                                    <div className="flex items-center">
                                        <IconMenuUsers className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Partners</span>
                                    </div>
                                </Link>
                            </li>
